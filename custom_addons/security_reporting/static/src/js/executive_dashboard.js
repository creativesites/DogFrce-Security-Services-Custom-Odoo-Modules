    ...
    async _loadData() {
        ...
        try {
            ...
            const [
                ...
                this.orm.searchCount("hr.employee", [["security_guard", "=", true], ["active", "=", true]]).catch(() => 0),
                this.orm.searchCount("security.attendance.record", [["shift_date", "=", today], ["status", "in", ["present", "late"]]]).catch(() => 0),
                this.orm.searchCount("security.attendance.record", [["shift_date", "=", today], ["absence_type", "=", "awol"]]).catch(() => 0),
                this.orm.searchCount("security.attendance.record", [["shift_date", "=", today], ["status", "=", "absent"]]).catch(() => 0),
                this.orm.searchCount("security.roster.slot", [["state", "=", "confirmed"], ["employee_id", "=", false]]).catch(() => 0),
                this.orm.searchCount("security.client.site", [["active", "=", true]]).catch(() => 0),
